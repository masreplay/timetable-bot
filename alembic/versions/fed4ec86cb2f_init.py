...
Revision ID: fed4ec86cb2f
Revises: 
Create Date: 2022-02-10 20:29:47.002108
...
def upgrade():
    ...
    sa.Column('color_light', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('color_dark', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
